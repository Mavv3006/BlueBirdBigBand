    ...
    <public-layout>
        ...
        <div class="section-wrapper">
            <section>
                ...
                <div>
                    <p>
                        ...
                        und in
                        welchem Umfang im Rahmen der Bereitstellung unserer Website verarbeiten.
                    </p>
                    <p>
            ...
            <section>
                ...
                <ul class="index">
                    <li>
                        <a class="index-link" href="#m4158">Präambel</a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a class="index-link" href="#m12">Allgemeine Informationen zur Datenspeicherung und
                            Löschung
                        </a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a class="index-link" href="#m225">Bereitstellung des Onlineangebots und Webhosting
                        </a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a class="index-link" href="#m17">Newsletter und elektronische Benachrichtigungen
                        </a>
                    </li>
                    <li>
                        <a class="index-link" href="#m136">Präsenzen in sozialen Netzwerken (Social Media)
                        </a>
                    </li>
                </ul>
            </section>
            ...
            <section>
                ...
                <div>
                    ...
                    <p>
                        E-Mail-Adresse:
                        <a href="mailto:bandleiter@bluebirdbigband.de">
                            bandleiter@bluebirdbigband.de
                        </a>
                    </p>
                    <p>
                        Telefon: 0171 5808481
                    </p>
                </div>
            </section>
            ...
            <section>
                ...
                <div>
                    ...
                    <p>
                        ...
                        im
                        Schweizer DSG verwendeten Begriffe „Bearbeitung" von „Personendaten", "überwiegendes Interesse"
                        und
                        "besonders schützenswerte Personendaten" werden die in der DSGVO verwendeten Begriffe
                        „Verarbeitung"
                        von „personenbezogenen Daten" sowie "berechtigtes Interesse" und "besondere Kategorien von
                        Daten"
            ...
            <section>
                ...
                <div>
                    ...
                    <p>
                        ...
                        signalisiert.
                        Dies dient als ein Indikator für die Nutzer, dass ihre Daten sicher und
            ...
            <section>
                ...
                <ul class="m-elements">
                    <li>
                        ...
                        textliche oder bildliche Nachrichten und Beiträge sowie die sie betreffenden Informationen, wie
                ...
                <ul class="m-elements">
                    ...
                    <li>
                        ...
                        protokolliert. Zu den Serverlogfiles können die Adresse und der Name der abgerufenen Webseiten
                        und Dateien, Datum und Uhrzeit des Abrufs, übertragene Datenmengen, Meldung über erfolgreichen
                        ...
                        lit. f) DSGVO). <strong>Löschung von Daten:</strong> Logfile-Informationen werden für die Dauer
                    ...
                    <li>
                        ...
                        Die von uns in Anspruch genommenen Webhosting-Leistungen umfassen ebenfalls den Versand, den
                        Empfang sowie die Speicherung von E-Mails. Zu diesen Zwecken werden die Adressen der Empfänger
                        sowie Absender als auch weitere Informationen betreffend den E-Mailversand (z.B. die beteiligten
                        ...
                        abgesendet und empfangen werden. Wir können daher für den Übertragungsweg der E-Mails zwischen
                        dem Absender und dem Empfang auf unserem Server keine Verantwortung übernehmen; <strong>Rechtsgrundlagen:</strong>
            ...
            <section>
                ...
                <ul>
                    ...
                    <li>
                        ...
                        der Einholung der Einwilligung), sollten sie davon ausgehen, dass diese permanent sind und die
            ...
            <section>
                ...
                <div>
                    <p>
                        ...
                        Grundlage. Sofern im Rahmen einer Anmeldung zum Newsletter dessen Inhalte genannt werden, sind
                        diese
                        Inhalte für die Einwilligung der Nutzer maßgeblich. Für die Anmeldung zu unserem Newsletter ist
                        normalerweise die Angabe Ihrer E-Mail-Adresse ausreichend. Um Ihnen jedoch einen
                        personalisierten
                        Service bieten zu können, bitten wir gegebenenfalls um die Angabe Ihres Namens für eine
                        persönliche
                        Ansprache im Newsletter oder um weitere Informationen, falls diese für den Zweck des Newsletters
                        notwendig sind.
                    </p>
                    <p>
                        Löschung und Einschränkung der Verarbeitung: Wir können die ausgetragenen E-Mail-Adressen bis zu
                        drei Jahren auf Grundlage unserer berechtigten Interessen speichern, bevor wir sie löschen, um
                        eine
                        ehemals gegebene Einwilligung nachweisen zu können. Die Verarbeitung dieser Daten wird auf den
                        Zweck
                        einer potenziellen Abwehr von Ansprüchen beschränkt. Ein individueller Löschungsantrag ist
                        jederzeit
                        möglich, sofern zugleich das ehemalige Bestehen einer Einwilligung bestätigt wird. Im Fall von
                    ...
                    <p>
                        ...
                        zum
                        Zweck des Nachweises seines ordnungsgemäßen Ablaufs. Soweit wir einen Dienstleister mit dem
                        Versand
...
<!--                        sogenannten „Web Beacons", d. h. eine pixelgroße Datei, die beim Öffnen des Newsletters von-->
<!--                        unserem bzw. dessen Server, sofern wir einen Versanddienstleister einsetzen, abgerufen wird. Im-->
<!--                        Rahmen dieses Abrufs werden zunächst sowohl technische Informationen, wie beispielsweise Angaben-->
<!--                        zum Browser und Ihrem System, als auch Ihre IP-Adresse und der Zeitpunkt des Abrufs erhoben.-->
...
<!--                        mithilfe der IP-Adresse bestimmbar sind) oder der Zugriffszeiten genutzt. Diese Analyse-->
<!--                        beinhaltet ebenfalls die Feststellung, ob und wann die Newsletter geöffnet und welche Links-->
<!--                        angeklickt werden. Die Informationen werden den einzelnen Newsletterempfängern zugeordnet und in-->
<!--                        deren Profilen bis zur Löschung gespeichert. Die Auswertungen dienen dazu, die Lesegewohnheiten-->
<!--                        unserer Nutzer zu erkennen und unsere Inhalte an sie anzupassen oder unterschiedliche Inhalte-->
<!--                        entsprechend den Interessen unserer Nutzer zu versenden. Die Messung der Öffnungs- und-->
<!--                        Klickraten sowie die Speicherung der Messergebnisse in den Profilen der Nutzer <strong>Rechtsgrundlagen:</strong>-->
            ...
            <section>
                ...
                <ul class="m-elements">
                    <li>
                        ...
                        Seiten; <strong>Dienstanbieter:</strong> Meta Platforms Ireland Limited, Merrion Road, Dublin 4,
                        D04 X2K5, Irland; <strong>Rechtsgrundlagen:</strong> Berechtigte Interessen (Art. 6 Abs. 1 S. 1
                        ...
                        <strong>Datenschutzerklärung:</strong> <a href="https://privacycenter.instagram.com/policy/"
                                                                  target="_blank">https://privacycenter.instagram.com/policy/</a>.
...
ul {
    @apply list-disc pl-4 mt-6 mb-6;
}
