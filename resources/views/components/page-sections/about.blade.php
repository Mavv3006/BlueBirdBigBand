    ...
    <div class="mt-4 gap-4 flex flex-col px-2 lg:px-0">
        <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
            <div class="flex gap-4 flex-col justify-center">
                ...
                <p>
                    Alle Altersstufen sind darin vertreten, der Jüngste ist 12, der älteste über 70 Jahre alt. Die
                    größte Mehrheit der Bigband-Mitglieder zählt allerdings zwischen 25 und 45 Lenze.
                </p>
            </div>
