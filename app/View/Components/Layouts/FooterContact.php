    ...
    public function __construct()
    {
        $this->contactLinks = [
            new FooterContactLinkDto(
                name: 'Mausbergweg 144, 67346 Speyer',
            ...
            new FooterContactLinkDto(
                name: '0171 5808481',
                icon: 'fa-phone',
                link: 'tel:01715808481',
            ),
            new FooterContactLinkDto(
                name: 'buchung@bluebirdbigband.de',
                icon: 'fa-envelope',
                link: 'mailto:buchung@bluebirdbigband.de',
            ),
            new FooterContactLinkDto(
                name: 'bandleiter@bluebirdbigband.de',
                icon: 'fa-envelope',
                link: 'mailto:bandleiter@bluebirdbigband.de',
            ),
        ];
    }
