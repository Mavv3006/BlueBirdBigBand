...
class StoreConcertRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'venue.new_plz' => ['exclude_if:venue.create_new_venue,false', 'required', 'digits:5', 'integer'],
            'venue.new_name' => ['exclude_if:venue.create_new_venue,false', 'required', 'string'],
            'venue.selected_plz' => ['exclude_if:venue.create_new_venue,true', 'required', 'integer', 'digits:5', 'exists:venues,plz'],
